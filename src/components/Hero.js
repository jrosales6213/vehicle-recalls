    ...
    <div className="container hero  px-4 py-5">
      <Row className="flex-lg-row-reverse align-items-center g-5 py-5">
        ...
        <Col className="col-lg-6">
          ...
          <p className="lead">
            Manufacturers who determine that a product or piece of original
            equipment either has a safety defect, or is not in compliance with
            federal safety standards, are required to notify NHTSA within five
            business days. Find out if your vehicle has any recalls.
          </p>
